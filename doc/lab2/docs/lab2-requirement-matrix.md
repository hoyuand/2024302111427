...
| 要求 | 实现/证据 | 状态 |
|---|---|---|
| trampoline 保存与恢复现场 | `code/kernel/entry.S` 的 `s_trap_vector`、`userret_direct`；`struct trapframe` | 通过 |
...
| UART 中断接收与环形缓冲 | `code/kernel/console.c`、PLIC 初始化 | 通过 |
...
| Git 本地归档 | `lab2-start`、`lab2`、`lab2-submit`、`提交-lab2-2024302111427.zip` | 本地完成，未推送 |
