...
用法:
    ...
    #   qemu-system-riscv64 -machine virt -bios none -kernel code/kernel/kernel \
    #     -nographic -monitor unix:/tmp/m.sock,server,nowait
    python3 code/tools/monpeek.py /tmp/m.sock              # 默认 info registers
    python3 code/tools/monpeek.py /tmp/m.sock "info cpus"
